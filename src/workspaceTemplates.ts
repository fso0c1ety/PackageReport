...
export const WORKSPACE_TEMPLATES: WorkspaceTemplate[] = [
  ...
  { key: "warehouse_distribution", icon: "\u{1F3ED}", name: "Warehouse & Distribution", description: "Products, warehouses, stock movement, suppliers and inventory control", color: "#7c3aed", boards: [
    board("Products", [{ name: "SKU", type: "Text" }, { name: "Barcode", type: "Barcode" }, { name: "Category", type: "Tags" }, { name: "Unit Cost", type: "Money" }, { name: "Sale Price", type: "Money" }, { name: "Image", type: "Image" }, status(["Active", "Inactive"]) ]),
    board("Stock In", [{ name: "Product", type: "Relation" }, { name: "Warehouse", type: "Relation" }, { name: "Supplier", type: "Relation" }, { name: "Quantity", type: "Numbers" }, { name: "Date", type: "Date" }, { name: "Document", type: "Files" }]),
    board("Stock Out", [{ name: "Product", type: "Relation" }, { name: "Warehouse", type: "Relation" }, { name: "Customer", type: "Relation" }, { name: "Quantity", type: "Numbers" }, { name: "Date", type: "Date" }, { name: "Document", type: "Files" }]),
    board("Suppliers", [{ name: "Phone", type: "Phone" }, { name: "Email", type: "Email" }, { name: "Address", type: "Location" }, status(["Active", "Inactive"]) ]),
    board("Customers", [{ name: "Phone", type: "Phone" }, { name: "Email", type: "Email" }, { name: "Address", type: "Location" }, status(["Active", "Inactive"]) ]),
    board("Purchase Orders", [{ name: "Supplier", type: "Relation" }, { name: "Order Date", type: "Date" }, { name: "Expected Date", type: "Date" }, { name: "Amount", type: "Money" }, { name: "Documents", type: "Files" }, status(["Draft", "Ordered", "Received", "Cancelled"]) ]),
