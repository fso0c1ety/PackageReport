          ...
          <Stack spacing={{ xs: 6, md: 8 }} sx={{ mt: { xs: 7, md: 10 } }}>
            ...
            <Box sx={{ scrollMarginTop: 96 }}>
              ...
              {(() => { const previews: Record<string, { image: string; copy: string }> = {
                Dashboard: { image: marketingScreenshots.dashboard, copy: "See priorities, progress and performance in one clear operational overview." },
            ...
            <Box id="solutions" sx={{ scrollMarginTop: 96, p: { xs: 3, md: 5 }, borderRadius: 5, bgcolor: "#11152d", color: "#fff" }}>
              ...
              {(() => { const industries: Record<string, { image: string; name: string; copy: string; capabilities: string }> = {
                ...
                Manufacturing: { image: marketingScreenshots.boards, name: "Manufacturing", copy: "Coordinate orders, materials, machines and production reporting.", capabilities: "Orders • Materials • Machines • Quality" },
