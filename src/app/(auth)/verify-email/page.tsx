...
function VerifyEmailContent() {
  ...
  useEffect(() => {
    if (!token) { setState({ loading: false, message: "", error: "Verification token is missing" }); return; }
    publicFetch(getApiUrl("auth/verify-email"), {
  ...
  return <Paper sx={{ width: "100%", maxWidth: 480, m: 2, p: 4, borderRadius: 3 }}>
    <Typography variant="h4" fontWeight={800} mb={1}>Verify email</Typography>
    <Typography color="text.secondary" mb={3}>Securing your Smart Manage account.</Typography>
